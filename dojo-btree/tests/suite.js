...
module.exports = {
    ...
    "bench": {
        "init": function(test) {
            Tree = btree.create(100);
            tree = new Tree();
            test.done();
        },
        
        "put100k": function(test) {
        ...
        "walk100k": {
            "asc": function(test) {
                var n=0;
                tree.walkAsc(0, 200000, function(key, value) {
                    test.strictEqual(key, value);
                    n++;
                });
                test.strictEqual(n, 100000);
                test.done();
            },
            
            "desc": function(test) {
                var n=0;
                tree.walkDesc(0, 200000, function(key, value) {
                    test.strictEqual(key, value);
                    n++;
                });
                test.strictEqual(n, 100000);
            ...
            "count": function(test) {
                test.strictEqual(tree.count(0, 200000), 100000);
                test.done();
            }
        },
